        ...
        <div>
            <div className='m-auto w-3/4 mt-20'>
                <h1 className="mb-4 text-5xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                    <span className="max-xl:text-6xl text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 text-8xl">SmartCard</span>
                </h1>
                ...
                <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-white">Вчи англійську мову граючись.</p>
            </div>
            <div className='flex justify-between max-xl:flex-col max-xl:items-center w-4/5 m-auto mt-16'>
                <Link to="/signin"
                   className="block max-w-xs max-xl:max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-navbar dark:border-white dark:hover:bg-gray-700">
                ...
                <Link to="/dictionary"
                   className="block max-w-xs max-xl:max-w-lg max-xl:mt-5 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-navbar dark:border-white dark:hover:bg-gray-700">
