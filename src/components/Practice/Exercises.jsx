        ...
        <div>
            <div className='flex justify-between w-5/6 max-lg:flex-col max-lg:w-1/2  m-auto mt-16'>
                <Link to="/first-step" id='first-step'
                      className="block max-w-sm max-xs:w-1/5 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-navbar  dark:border-white dark:hover:bg-gray-700">
                ...
                <Link to="/second-step"
                      className="max-lg:mt-5 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-navbar dark:border-white dark:hover:bg-gray-700">
                    <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Другий крок
                    </h5>
