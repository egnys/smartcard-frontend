...
const AddForm = ({setAddWord, updateInfo}) => {
    const handleClick = () =>{
        setAddWord(false)
    }
        ...
        <div
            ...
            <form>
                <div>
                    ...
                    <input type="text" name="text" id="text" onChange={e => setWord(e.target.value)} value={word}
                ...
                <div className='mt-3'>
                    ...
                    <input type="text" name="text" id="text" onChange={e => setTranslate(e.target.value)} value={translation}
                           className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                           required
                    />
                </div>
